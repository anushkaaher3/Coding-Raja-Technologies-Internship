...
class todo:
    def __init__(self, root):
        ...
        self.label3 = Label(self.root, text='Tasks', font = 'ariel, 25 bold',width = 10, bd =5, bg ='orange', fg = 'black')
        self.label3.place(x=320, y=54)

        self.main_text = Listbox(self.root, height=9, bd=5, width=23, font="ariel, 20italic bold")
